...
## Overview
`Godel.Microservices.Core` project contains base components and interfaces of Microservices Framework. Whole idea of framework is based on components called **initializers**. 
...
2. Reference latest version of `Godel.Microservices.Core` nuget package and optionally satellite packages you would like to use.
