...
Execute unit tests
```
    cd "GodelTech.Microservices.AwsLambda/test/GodelTech.Microservices.AwsLambda.Tests"
    dotnet test
```

Deploy application
```
    cd "GodelTech.Microservices.AwsLambda/src/GodelTech.Microservices.AwsLambda"
